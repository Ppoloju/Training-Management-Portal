...
@Schema(description = "Request to update an existing training program")
public record TrainingProgramUpdateRequest(
    ...
    @Schema(description = "The status of the training program", example = "IN_PROGRESS")
